...
## Method Section in Academic Papers {.smaller}
...
```{r}
include_graphics("https://dotuml.com/img/googledocs.200.png")
```
...
## Auto-LaTeX Equations for Google Docs {.smaller}
...
```{r}
include_graphics("https://mathpix.com/images/google-docs-power-point2.webp")
```
...
```{r}
include_graphics("raw.githubusercontent.com/varkor/quiver/refs/heads/master/screenshots/title.png")
```
