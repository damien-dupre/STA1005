...
Appendices are possible, especially if they include code to reproduce the results. They are not included in the page count.
...
.centre[**Introduction `r ji("right_arrow")` Literature Review `r ji("right_arrow")` Method `r ji("right_arrow")` Results `r ji("right_arrow")` Discussion & Conclusion**]
...
Imagine the variability of the Outcome Variable is a birthday cake. 
...
.centre[The effect of {**predictor 1**} on {**outcome**} is explained by the {**predictor 2**}]
...
4. Professors who use a student-centreed teaching method will have a greater positive rapport with their graduate students than professors who use a teacher-centreed teaching method.
