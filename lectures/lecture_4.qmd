...
- Short description of the variables (predictors and outcome).
...
- Communicating hypothesis testing results and conclude **if the alternative hypothesis considered as plausible or if the null hypothesis is not rejected.**
...
Figure 1: Scatterplot mapping every employee according their Salary and their Job Satisfaction.
:::
...
Figure 2: Scatterplot with effect overlay, showing the best model under $H_1$ and the null model under $H_0$
:::
::::
...
## Reporting the Model Fit Measure Table {.smaller}
...
## More Model Fit Measures {.smaller}
...
## Communicate Model Fit Measures {.smaller}
...
## Reporting the Model Coefficients Table {.smaller}
...
## Communicate Model Coefficients {.smaller}
...
## Interaction Effect Example {.smaller background="#43464B"}
...
## Interaction Effect Example {background="#43464B"}
